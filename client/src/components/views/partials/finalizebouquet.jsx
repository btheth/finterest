...
class FinalizeBouquet extends Component {
  ...
  handleCheckOut() {
    ...
    xhr.open('post', '/api/users/cust/addbouquet');
    ...
    return (
      <div>
        ...
        <div id="finalize-footer">
          ...
          <button onClick={this.handleAddToCart} id="submit-bouquet" className="finalize-btn btn btn-success">Add to cart</button>
          <button onClick={this.handleCheckOut} id="submit-bouquet" className="finalize-btn btn btn-success">Check out</button>
...
export default FinalizeBouquet;